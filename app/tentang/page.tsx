            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 pb-20">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <MotionWrapper delay={0.3} type="slideUp">
                        <div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-100 h-full hover:shadow-2xl transition-shadow duration-300">
                            <div className="w-12 h-12 bg-blue-100 rounded-2xl flex items-center justify-center mb-6 text-blue-600 transition-transform duration-300 hover:scale-110 hover:rotate-6">
                                <Target size={28} strokeWidth={2.5} />
                            </div>
                            <h2 className="text-2xl font-bold text-slate-900 mb-4">Misi Kami</h2>
                            <p className="text-slate-600 leading-relaxed mb-6">
                                CitraPlus hadir untuk memberikan akses mudah ke teknologi peningkatan kualitas gambar kelas profesional bagi <strong>semua orang</strong>.
                                Tidak peduli apakah Anda seorang fotografer, desainer grafis, pembuat konten, atau pengguna awam,
                                kami membantu Anda mendapatkan hasil terbaik dari setiap foto.
                            </p>
                            <ul className="space-y-3">
                                {[
                                    'Mempertajam detail foto yang kabur atau kurang fokus.',
                                    'Meningkatkan kualitas visual untuk keperluan profesional.',
                                    'Memahami cara kerja manipulasi citra digital secara interaktif.',
                                    'Bebas digunakan tanpa perlu instalasi software berat.'
                                ].map((item, i) => (
                                    <li key={i} className="flex items-start gap-3 group cursor-default">
                                        <CheckCircle className="w-5 h-5 text-blue-500 mt-1 flex-shrink-0 transition-transform duration-300 group-hover:scale-125 group-hover:text-blue-600" />
                    ...
                    <div className="space-y-8">
                        <MotionWrapper delay={0.4} type="slideUp">
                            <div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-100 hover:shadow-2xl transition-shadow duration-300">
                                <div className="w-12 h-12 bg-indigo-100 rounded-2xl flex items-center justify-center mb-6 text-indigo-600 transition-transform duration-300 hover:scale-110 hover:rotate-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    {/* Next.js */}
                                    <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 hover:bg-slate-100 transition-all duration-300 group hover:-translate-y-1 hover:shadow-md cursor-default">
                                        <div className="flex items-center gap-2 font-bold text-slate-900 mb-1">
                                            <span className="text-slate-900 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6">
                                    ...
                                    <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 hover:bg-slate-100 transition-all duration-300 group hover:-translate-y-1 hover:shadow-md cursor-default">
                                        <div className="flex items-center gap-2 font-bold text-slate-900 mb-1">
                                            <span className="text-blue-600 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6">
                                    ...
                                    <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 hover:bg-slate-100 transition-all duration-300 group hover:-translate-y-1 hover:shadow-md cursor-default">
                                        <div className="flex items-center gap-2 font-bold text-slate-900 mb-1">
                                            <span className="text-sky-500 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6">
                                    ...
                                    <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 hover:bg-slate-100 transition-all duration-300 group hover:-translate-y-1 hover:shadow-md cursor-default">
                                        <div className="flex items-center gap-2 font-bold text-slate-900 mb-1">
                                            <span className="text-purple-600 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6">
                                                <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
